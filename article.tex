...
\begin{table}[h]
  \caption{Segmentation Model Comparison: Vanilla U-Net vs EfficientNet-B4 U-Net}
  \centering
  \begin{tabular}{lccc}
    \toprule
    Model & Dice Score & Loss & IoU \\
    \midrule
    Vanilla U-Net & X.XX\% & X.XXX & X.XX\% \\
    EfficientNet-B4 U-Net & \textbf{X.XX\%} & \textbf{X.XXX} & \textbf{X.XX\%} \\
    \bottomrule
  \end{tabular}
